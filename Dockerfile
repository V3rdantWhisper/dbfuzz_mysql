...
USER mysql
WORKDIR /home/mysql/
RUN wget https://archives.boost.io/release/1.77.0/source/boost_1_77_0.tar.bz2 && tar -xf boost_1_77_0.tar.bz2
...
RUN cp -r ~/boost_1_77_0 ../boost && cmake ../ -DWITH_BOOST=../boost -DWITH_UNIT_TESTS=OFF -DUSE_LD_GOLD=1 -DWITH_DEBUG=1
RUN make -j$(nproc)
