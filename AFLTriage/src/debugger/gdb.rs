...
impl GdbTriager {
    ...
    pub fn triage_program(
        ...
        let input_file_raw = Some(format!("{} {}", String::from("drop database if exists test_sqlright1; create database test_sqlright1; use test_sqlright1;"), String::from_utf8(read_file_to_bytes(input_file).unwrap().clone()).unwrap()).as_bytes().to_vec());
